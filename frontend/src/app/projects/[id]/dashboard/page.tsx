                                                        ...
                                                        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                                                            {[
                                                                ...
                                                                <div key={i} className="card p-5">
                                                                    ...
                                                                    <div className={`text-2xl font-bold ${stat.good !== undefined ? (stat.good ? 'text-green-400' : 'text-red-400') : 'text-white'
                                                                        }`}>
                                                                        {stat.value}
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <div className="card p-5">
                                                            ...
                                                            <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
                                                                ...
                                                                <div className="bg-white/[0.02] rounded-lg p-4 border border-white/[0.06]">
                                                                    ...
                                                                    <div className={`text-xl font-bold ${report.error_rate < 0.05 ? 'text-emerald-400' : 'text-amber-400'}`}>
                                                                    ...
                                                                    <tbody>
                                                                        {report.endpoint_metrics.map((endpoint: any, i: number) => (
                                                                            <tr key={i} className="border-b border-white/5">
                                                                                ...
                                                                                <td className={`py-3 px-4 text-right ${endpoint.error_rate < 0.05 ? 'text-emerald-400' : 'text-red-400'
                                                                                    }`}>
