        ...
        <main className="min-h-screen flex items-center justify-center px-6" style={{ background: '#111113' }}>
            <div className="w-full max-w-md">
                ...
                <div className="text-center mb-8">
                    ...
                    <p className="text-white/40">Start load testing your APIs today</p>
                </div>
                ...
                <div className="bg-white/[0.02] border border-white/[0.08] rounded-2xl p-8">
                    ...
                    <div className="relative mb-6">
                        ...
                        <div className="relative flex justify-center text-xs">
                            <span className="bg-[#111113] px-4 text-white/30">or sign up with email</span>
                        </div>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <div>
                            <label htmlFor="password" className="block text-white/50 text-sm mb-2">Password</label>
                            <input
                                id="password"
                                type="password"
                                value={password}
                        ...
                        <div>
                            <label htmlFor="confirmPassword" className="block text-white/50 text-sm mb-2">Confirm Password</label>
                            <input
                                id="confirmPassword"
                                type="password"
                ...
                <p className="text-white/30 text-sm text-center mt-6">
                    Free tier includes 50 credits to start
                </p>
            </div>
        </main>
    );
