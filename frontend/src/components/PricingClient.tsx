...
export default function PricingClient() {
    ...
    const faqs = [
        ...
        },
        {
            ...
            a: 'Unused credits can be refunded within 30 days of purchase. Contact support at support@apistresslab.com for refund requests.'
        },
        {
            q: 'What payment methods do you accept?',
            a: 'We accept all major credit cards (Visa, MasterCard, American Express, Discover) via Stripe. All payments are secure and PCI compliant.'
        },
        {
            q: 'What if a test fails?',
            a: 'If a test fails due to an error on our end, credits are automatically refunded to your account. You only pay for successful test runs.'
        },
        {
            q: 'Is there a free tier?',
            a: 'Yes! New users receive 50 free credits (no credit card required) to try API Stress Lab and run multiple test scenarios.'
        },
        {
            q: 'How are credits calculated?',
            a: 'Credits are calculated based on the larger of requests or compute time using the formula: max(requests ÷ 10,000, VU-minutes ÷ 50) with a minimum of 5 credits per test.'
        }
    ];
